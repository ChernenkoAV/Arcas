...
public class WsdlXsdGenSettingT
{
    public String WsdlPathToWsdl { get; set; }
    public String WsdlPathToSaveFile { get; set; }
    public String WsdlNamespace { get; set; }
    public string XsdPathToXsd { get; set; }
    public string XsdPathToSaveFile { get; set; }
